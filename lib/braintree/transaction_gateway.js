...
TransactionGateway = (function(superClass) {
  extend(TransactionGateway, superClass);
  ...
  TransactionGateway.prototype.refund = function() {
    var amount, callback, i, transactionId;
    transactionId = arguments[0], amount = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), callback = arguments[i++];
  ...
  TransactionGateway.prototype.submitForSettlement = function() {
    var amount, attributes, callback, i, options, transactionId;
    transactionId = arguments[0], attributes = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), callback = arguments[i++];
    amount = attributes[0];
...
//# sourceMappingURL=transaction_gateway.js.map
